...
func (cs *Service) SaleTrx(params transactiondata.TransactionData) {
...
func (cs *Service) ErrorClear(ctx context.Context, idTrxData int64, idTrx int64, afterSave int64) {
